...
// app.get('/googleBook/:word' ,function(req,res){
//     urllib.request(`https://www.googleapis.com/books/v1/volumes?q=title:${word}`, function (err,title) {
//         if (err) {
//             console.log("error, try again")
//             throw err
//         }
        
//         let players = JSON.parse(title.toString()).items[0].volumeInfo.title
//         // console.log(JSON.parse(playerData.toString()).league.standard)
